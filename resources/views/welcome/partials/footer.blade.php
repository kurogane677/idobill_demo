    ...
    {{-- Preload biar loading muter muter kayak Naruto --}}
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6">
            ...
            <form action="mailto:cs@idobill.com" method="post">
            @csrf
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="{{url('/tv-cable')}}">TV Cable</a></li>
            </ul>
          </div>
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>GrahaNet</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
