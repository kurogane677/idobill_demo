...
<header id="header" class="d-flex align-items-center">
  <div class="container d-flex align-items-center justify-content-between">
    ...
    <a href="{{url('/')}}" class="logo"><img src="{{asset('images/grahakomindo_logo.png') }}" alt=""></a>

    <nav id="navbar" class="navbar">
      <ul>
        <li><a class="nav-link scrollto {{request()->is('/')?'active':''}}" href="{{url('/')}}">Home</a></li>
        <li class="dropdown"><a class="nav-link scrollto {{request()->is('staff')?'active':''}}" href="#">About Us<i class="bi bi-chevron-down"></i></a>
          <ul>
            <li><a class="nav-link scrollto" href="#">Partnership</a></li>
            <li><a class="nav-link scrollto" href="{{url('/staff')}}">Our Team</a></li>
          </ul>
        </li>
        <li class="dropdown"><a class="nav-link scrollto {{request()->is('apart','bisnis','desa','super-internet')?'active':''}}" href="#">Products<i class="bi bi-chevron-down"></i></a>
          <ul>
            <li class="dropdown"><a class="nav-link scrollto" href="{{url('/super-internet')}}"><span>Super Internet</span> <i class="bi bi-chevron-right"></i></a>
              <ul>
        ...
        <li class="dropdown"><a class="nav-link scrollto {{request()->is('contact')?'active':''}}" href="#">Support  <i class="bi bi-chevron-down"></i></a>
          <ul>
