<button type="button" class="btn btn-danger btn-sm" id="reset" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-delay='{"hide":"100"}' title="Reset Filter">
