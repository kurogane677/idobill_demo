...
<div class="row flex-center">
  <a href="{{route('stb.index')}}" class="btn btn-sm btn-primary">Alokasi Perangkat</a>
  <div class="mx-2"></div>
  <a href="{{route('router.index')}}" class="btn btn-sm btn-outline-primary">Aktivasi Perangkat</a>
  {{-- <div class="mx-2"></div>
...
@section('menu-header')
<h5 class="pt-2">{{$module->section}} Perangkat</h5>
@endsection
...
<script>
  ...
  $(function() {
    var tblID = "#alokasi-table"
    var table = $("#alokasi-table").DataTable();
