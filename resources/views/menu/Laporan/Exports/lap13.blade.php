  ...
  <table id="table_preview_main" class="table table-sm table_preview">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-center" style="width: 15px;">{{$item->subs_products}}</td>
        <td class="text-center" style="width: 10px;">Rp. {{number_format($item->grand_total)}}</td>
        <td class="text-center" style="width: 10px;">{{$item->credit_date}}</td>
        <td class="text-center" style="width: 10px;">Rp. {{number_format($item->credit_amount)}}</td>
        <td class="text-center" style="width: 10px;">{{$item->credit_remark}}</td>
...
<tfoot>
  <tr>
    ...
    <td></td>
    <td class="text-center">Rp.{{number_format($TableLaporan['credits'])}}</td>
    <td></td>
  </tr>
</tfoot>
</table>
