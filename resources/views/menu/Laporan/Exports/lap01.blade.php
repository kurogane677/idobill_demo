...
<div class="container-fluid">
  ...
  <h5 class="text-center"><strong>LAPORAN DATA PELANGGAN</strong></h5><br/>
  ...
  <table id="table_preview_main" class="table table-sm table_preview">
    ...
    <tfoot>
      <tr>
        <td colspan="8" align="right">Total Pelanggan Baru</td>
        <td>{{($TableLaporan['baru'])}} Orang</td>
      </tr>
      <tr>
        <td colspan="8" align="right">Total Pelanggan Aktif</td>
        <td>{{($TableLaporan['aktif'])}} Orang</td>
      </tr>
      <tr>
        <td colspan="8" align="right">Total Pelanggan Putus Sementara</td>
        <td>{{($TableLaporan['sementara'])}} Orang</td>
      </tr>
      <tr>
        <td colspan="8" align="right">Total Pelanggan Putus Permanen</td>
        <td>{{($TableLaporan['perm'])}} Orang</td>
      </tr>
    </tfoot>
  </table>
  ...
  <table>
    <tbody>
      <tr>
        <td>Terbilang Total Pelanggan Baru</td>
        <td class="font-italic">{{': '.($TableLaporan['baru'])}} Orang</td>
      </tr>
      <tr>
        <td>Total Pelanggan Aktif</td>
        <td class="font-italic">{{': ' . ($TableLaporan['aktif'])}} Orang</td>
      </tr>
      <tr>
        <td>Total Pelanggan Putus Sementara</td>
        <td class="font-italic">{{': ' . ($TableLaporan['sementara'])}} Orang</td>
      </tr>
      <tr>
        <td>Total Pelanggan Putus Permanen</td>
        <td class="font-italic">{{': ' . ($TableLaporan['perm'])}} Orang</td>
      </tr>
    </tbody>
  </table>
