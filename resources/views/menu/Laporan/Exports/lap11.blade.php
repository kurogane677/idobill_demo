  ...
  <table id="table_preview_main" class="table table-sm table_preview">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-center" style="width: 10px;">{{$item->inv_status}}</td>
        ...
        {{-- <td class="text-center" style="width: 10px;">Rp. {{number_format($item->prod_price)}}</td> --}}
...
<tfoot>
  <tr>
    ...
    <td class="text-center">Rp. {{number_format($TableLaporan['tagihan'])}}</td><td></td>
