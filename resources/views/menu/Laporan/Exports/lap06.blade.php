  ...
  <table id="table_preview_main" class="table table-sm table_preview">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-center" style="width: 10px;">{{$item->cust_name}}</td>
        <td class="text-center" style="width: 10px;">{{$item->prod_desc}}</td>
        <td class="text-center" style="width: 10px;">{{date('d-M-Y'),strtotime($item->paid_date)}}</td>
        <td class="text-center" style="width: 80px;">{{ $item->inv_status = "Sudah Bayar" }}</td>
        <td class="text-center" style="width: 10px;">Rp. {{number_format($item->grand_total)}}</td>
        <td class="text-center" style="width: 10px;">Rp. {{number_format($item->received_total)}}</td>
...
<tfoot>
  <tr>
    ...
    <td class="text-center" colspan="2">Rp. {{number_format($TableLaporan['total'])}}</td>
  </tr>
  <tr>
    <td class="text-right" colspan="8">Total Terima</td>
    <td class="text-center" colspan="2">Rp. {{number_format($TableLaporan['receive'])}}</td>
  </tr>
</tfoot>
</table>
